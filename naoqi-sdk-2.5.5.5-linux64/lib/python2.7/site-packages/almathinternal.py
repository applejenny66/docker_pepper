...
def isConvex(*args):
  """isConvex(vectorPosition2D pInputPoints) -> bool"""
  return _almathinternal.isConvex(*args)
...
def computePolygonCentroid(*args):
  """computePolygonCentroid(vectorPosition2D pPolygon) -> Position2D"""
  return _almathinternal.computePolygonCentroid(*args)
...
class Key(_object):
    ...
    def clone(self):
        """clone(Key self) -> Key"""
        return _almathinternal.Key_clone(self)

    def serialize(self):
        """serialize(Key self) -> boost::property_tree::ptree"""
        return _almathinternal.Key_serialize(self)

    def deserialize(self, *args):
        """deserialize(Key self, boost::property_tree::ptree const & tree) -> bool"""
        return _almathinternal.Key_deserialize(self, *args)
...
def new_clone(*args):
  """new_clone(Key pKey) -> Key"""
  return _almathinternal.new_clone(*args)
...
class ALInterpolationBezier(_object):
    ...
    def interpolate(self, *args):
        """
        interpolate(ALInterpolationBezier self, float pDuration, Key pFromKey, Key pToKey, float pMinValue, float pMaxValue, float pValueIncrementLimit, 
            float pDt) -> vectorFloat
    ...
    def interpolatePos(self, *args):
        ...
        return _almathinternal.ALInterpolationBezier_interpolatePos(self, *args)

    def interpolateVel(self, *args):
        ...
        return _almathinternal.ALInterpolationBezier_interpolateVel(self, *args)
    ...
    def setIsFinished(self, *args):
        ...
        return _almathinternal.ALInterpolationBezier_setIsFinished(self, *args)

    __swig_destroy__ = _almathinternal.delete_ALInterpolationBezier
    __del__ = lambda self : None;
    def init(self, *args):
        """
        init(ALInterpolationBezier self, float pDuration, Key pFromKey, Key pToKey, float pMinValue, float pMaxValue, float pValueIncrementLimit, 
            float pDt)
    ...
    def getCurrentInterpolation(self, *args):
        ...
        return _almathinternal.ALInterpolationBezier_getCurrentInterpolation(self, *args)
...
class BezierCurve(_object):
    ...
    def getBezierY(self, *args):
        """getBezierY(BezierCurve self, Position2D pP0, Position2D pP1, Position2D pP2, Position2D pP3, float pS) -> float"""
        return _almathinternal.BezierCurve_getBezierY(self, *args)

    def getBezierPosition(self, *args):
        ...
        return _almathinternal.BezierCurve_getBezierPosition(self, *args)

    def getBezierPositionAndTangent(self, *args):
        """
        getBezierPositionAndTangent(BezierCurve self, Position2D pP0, Position2D pP1, Position2D pP2, Position2D pP3, float pS, Position2D pPositionResult, 
            Position2D pTangentResult)
        """
        return _almathinternal.BezierCurve_getBezierPositionAndTangent(self, *args)
...
def computeNumberSamples(*args):
  """computeNumberSamples(Position2D pP0, Position2D pP3, float pDt) -> unsigned int"""
  return _almathinternal.computeNumberSamples(*args)

def computePolygonValue(*args):
  """
    computePolygonValue(Position2D pP0, Position2D pP1, Position2D pP2, Position2D pP3, float & pA, float & pB, 
        float & pC)
    """
  return _almathinternal.computePolygonValue(*args)

def getCurrentParameter(*args):
  """getCurrentParameter(float pA, float pB, float pC, float pTime, float & pLastParameter) -> float"""
  return _almathinternal.getCurrentParameter(*args)
...
class ALInterpolationBangBangAcceleration(_object):
    ...
    def __init__(self, *args): 
        ...
        __init__(AL::Math::Interpolation::ALInterpolationBangBangAcceleration self, float pPositionFinal, Limits pLimits, float pPeriod, AL::Math::Interpolation::ALInterpolationBangBangAcceleration::Policy pPolicy=DefaultPolicy) -> ALInterpolationBangBangAcceleration
        __init__(AL::Math::Interpolation::ALInterpolationBangBangAcceleration self, float pPositionFinal, Limits pLimits, float pPeriod) -> ALInterpolationBangBangAcceleration
        """
    ...
    def init(self, *args):
        ...
        init(ALInterpolationBangBangAcceleration self, float pPositionInit, float pPositionFinal, float pVelocityInit, Limits pLimits, float pPeriod, 
            AL::Math::Interpolation::ALInterpolationBangBangAcceleration::Policy pPolicy=DefaultPolicy)
        init(ALInterpolationBangBangAcceleration self, float pPositionInit, float pPositionFinal, float pVelocityInit, Limits pLimits, float pPeriod)
        """
...
class AnyInterpolator(_object):
    """Proxy of C++ AL::Math::Interpolation::AnyInterpolator class"""
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, AnyInterpolator, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, AnyInterpolator, name)
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    __swig_destroy__ = _almathinternal.delete_AnyInterpolator
    __del__ = lambda self : None;
    def setInitState(self, *args):
        """setInitState(AnyInterpolator self, vectorFloat pInitState)"""
        return _almathinternal.AnyInterpolator_setInitState(self, *args)

    def getCurrentInterpolation(self, *args):
        """getCurrentInterpolation(AnyInterpolator self, float pTime, unsigned int pOrder, vectorFloat pOutput)"""
        return _almathinternal.AnyInterpolator_getCurrentInterpolation(self, *args)

AnyInterpolator_swigregister = _almathinternal.AnyInterpolator_swigregister
AnyInterpolator_swigregister(AnyInterpolator)

class BezierSequence(AnyInterpolator):
    """Proxy of C++ AL::Math::Interpolation::BezierSequence class"""
    __swig_setmethods__ = {}
    for _s in [AnyInterpolator]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, BezierSequence, name, value)
    __swig_getmethods__ = {}
    for _s in [AnyInterpolator]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, BezierSequence, name)
    __repr__ = _swig_repr
    def __init__(self, *args): 
        """
        __init__(AL::Math::Interpolation::BezierSequence self, vectorFloat pInitState, float pPeriod, unsigned int pOrder) -> BezierSequence
        __init__(AL::Math::Interpolation::BezierSequence self, float pPeriod, unsigned int pOrder) -> BezierSequence
        """
    ...
    def addOffset(self, *args):
        """addOffset(BezierSequence self, float pOffset)"""
        return _almathinternal.BezierSequence_addOffset(self, *args)

    def addOffsetWithSaturation(self, *args):
        """addOffsetWithSaturation(BezierSequence self, float pOffset, float pMinValue, float pMaxValue)"""
        return _almathinternal.BezierSequence_addOffsetWithSaturation(self, *args)
